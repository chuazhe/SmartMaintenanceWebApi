...
{
    public class MaintenancePartContext : DbContext
    {
        //For OnConfiguring
        public MaintenancePartContext()
        {
        }
        ...
        public MaintenancePartContext(DbContextOptions<MaintenancePartContext> options) : base(options)
        { }
