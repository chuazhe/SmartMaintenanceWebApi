...
{
    public class AircraftPartContext : DbContext
    {
        //For OnConfiguring
        public AircraftPartContext()
        {
        }
        ...
        public AircraftPartContext(DbContextOptions<AircraftPartContext> options) : base(options)
        { }

        //The object for the context
        public DbSet<AircraftPart> AircraftPart { get; set; }
