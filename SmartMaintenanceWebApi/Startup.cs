...
using SmartMaintenanceWebApi.Services;
...
Configuration["Data:SmartMaintenanceDatabase:ConnectionString"]));
            ...
            services.AddDbContext<OrderPartContext>(options =>
options.UseSqlServer(
Configuration["Data:SmartMaintenanceDatabase:ConnectionString"]));

            services.AddDbContext<MaintenancePartContext>(options =>
options.UseSqlServer(
Configuration["Data:SmartMaintenanceDatabase:ConnectionString"]));

            services.AddDbContext<AircraftPartContext>(options =>
options.UseSqlServer(
Configuration["Data:SmartMaintenanceDatabase:ConnectionString"]));

            services.AddDbContext<AircraftEngineContext>(options =>
options.UseSqlServer(
Configuration["Data:SmartMaintenanceDatabase:ConnectionString"]));
...
Configuration["Data:SmartMaintenanceDatabase:ConnectionString"]));
            ...
            services.AddDbContext<EnginePartContext>(options =>
options.UseSqlServer(
Configuration["Data:SmartMaintenanceDatabase:ConnectionString"]));
